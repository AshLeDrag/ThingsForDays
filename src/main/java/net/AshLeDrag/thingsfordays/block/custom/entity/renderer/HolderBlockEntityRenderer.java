...
public class HolderBlockEntityRenderer  implements BlockEntityRenderer<HolderBlockEntity> {
		...
		@Override public void render(HolderBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
