...
import net.AshLeDrag.thingsfordays.entity.client.TeleportSwordModel;
...
public class ModEventBusEvents {
		...
		public static void registerLayers(EntityRenderersEvent.RegisterLayerDefinitions event) {
				...
				event.registerLayerDefinition(TeleportSwordModel.LAYER_LOCATION, TeleportSwordModel::createBodyLayer);
		}
}
